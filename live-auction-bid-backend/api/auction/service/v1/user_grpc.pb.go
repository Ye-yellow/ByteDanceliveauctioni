...
func (c *userServiceClient) AdminCreateUser(ctx context.Context, in *AdminCreateUserRequest, opts ...grpc.CallOption) (*AdminCreateUserReply, error) {
	...
	err := c.cc.Invoke(ctx, UserService_AdminCreateUser_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userServiceClient) AdminUpdateUserRole(ctx context.Context, in *AdminUpdateUserRoleRequest, opts ...grpc.CallOption) (*AdminUpdateUserRoleReply, error) {
	...
	err := c.cc.Invoke(ctx, UserService_AdminUpdateUserRole_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var UserService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "api/auction/service/v1/user.proto",
}
