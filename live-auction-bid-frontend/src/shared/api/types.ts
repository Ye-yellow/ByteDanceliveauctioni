...
export type LotStatus = 'LOT_STATUS_UNSPECIFIED' | 'LOT_STATUS_DRAFT' | 'LOT_STATUS_READY' | 'LOT_STATUS_QUEUED' | 'LOT_STATUS_LIVE' | 'LOT_STATUS_SETTLED' | 'LOT_STATUS_CANCELLED';
