...
export type UserRole = 'USER_ROLE_UNSPECIFIED' | 'USER_ROLE_BUYER' | 'USER_ROLE_ANCHOR' | 'USER_ROLE_OPERATOR' | 'USER_ROLE_ADMIN';
...
export type RegisterReply = { user?: User; tokens?: AuthTokens; result?: ReplyResult };
